...
namespace MonsterSave.Runtime
{
    public class ListAdapter : IEnumerableAdapter
    {
        ...
        public object ConvertToSerializable(object native)
        {
            ...
            var adaptedElemType = TypeRegistry.GetAdapter(elemType)?.TargetType ?? elemType; // 获取适配器的目标类型
            ...
            var adapter = TypeRegistry.HasAdapter(elemType)
                ? TypeRegistry.GetAdapter(elemType)
                : null;
